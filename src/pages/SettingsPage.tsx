      ...
      <div className="glass-panel rounded-2xl p-6 border border-neutral-800 space-y-4 bg-neutral-950/40">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {!confirmPurgeOpen ? (
            ...
            <div className="flex items-center space-x-2 p-1.5 rounded-xl bg-rose-500/15 border border-rose-500/30 animate-in fade-in duration-150 shrink-0">
              <span className="text-xs text-rose-300 font-semibold px-2">Purge cache & hard reload?</span>
              <button
                disabled={isPurging}
                onClick={async () => {
                  setIsPurging(true);
                ...
                className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs shadow transition-all cursor-pointer disabled:opacity-50"
              >
                {isPurging ? (
                  <>
              ...
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg bg-neutral-800 hover:bg-neutral-700 text-neutral-300 text-xs font-semibold transition-all cursor-pointer"
              >
                Cancel
              </button>
            </div>
